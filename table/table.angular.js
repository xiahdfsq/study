define(['app'], function (services) {
    ...
    services.factory('yunService', function (session_service, http_service, convert_service) {
        ...
        yun.temp.systemId = yun.param.systemId = 'ICORE-AOPSMSG';
        if (window.appType == 'pro') {
            yun.param.callBackUrl = 'https://icore-aopsmsg.pingan.com.cn/mws/mws_app/mws_index.html#/main/renewal/renewal_car_insur';
        } else if (window.appType == 'test') {
            yun.param.callBackUrl = 'http://test-aopsmsg.pingan.com.cn:8010/mws/mws_app/mws_index.html#/main/renewal/renewal_car_insur';
        } else {
            yun.param.callBackUrl = 'http://172.16.17.232:30020/mws/mws_app/mws_index.html#/main/renewal/renewal_car_insur';
        }
